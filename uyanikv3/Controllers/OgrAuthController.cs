            ...
            using(var db = new U1710750DbCb9Context())
            {
                ...
                else
                {
                    ...
                    if (ogrControl(model.Telefon))
                    {
                        ...
                        onKayit.Okul = model.OkulSTR;
                        onKayit.Sinif = model.Sinif;
                        ...
                        string bildirimBaslik = "Şenol Hoca Rehberlik Akademiye Hoş Geldiniz";
                    ...
                    {
                        msgIcon = "info";
                        msgTitle = "Giriş İşlemi Başarısız";
                        msg = $"{model.Telefon} 'nolu telefon zaten kayıtlıdır. ";
                        return Json(new { msgTitle, msg, msgIcon });
                    }
