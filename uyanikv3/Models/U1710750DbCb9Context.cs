...
public partial class U1710750DbCb9Context : DbContext
{
    public U1710750DbCb9Context()
    {
    }

    public U1710750DbCb9Context(DbContextOptions<U1710750DbCb9Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=94.73.150.182;database=u1710750_dbCB9;user=u1710750_userCB9;password=R2_rj5E71.@Gs@Ja", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.6.16-mariadb"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Kutuphaneuyelikpaketler>(entity =>
        {
            ...
            entity
                .ToTable("kutuphaneuyelikpaketler")
                .UseCollation("utf8mb3_turkish_ci");
        ...
        modelBuilder.Entity<Kutuphaneuyelikpakettanimlamalar>(entity =>
        {
            ...
            entity
                .ToTable("kutuphaneuyelikpakettanimlamalar")
                .UseCollation("utf8mb3_turkish_ci");
        ...
        modelBuilder.Entity<Uyelikpaketikramtanimlamalar>(entity =>
        {
            ...
            entity
                .ToTable("uyelikpaketikramtanimlamalar")
                .UseCollation("utf8mb3_turkish_ci");
